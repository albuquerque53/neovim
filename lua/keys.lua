-- keys.lua
-- general and non plugin specific keybinds are here
vim.g.mapleader = ' '
...
vim.api.nvim_set_keymap('n', '<leader>ho', ':nohlsearch<cr>', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader>pi', ':PackerInstall<cr>', { noremap = true })
vim.api.nvim_set_keymap('n', '<C-n>', '*N', { noremap = true })
